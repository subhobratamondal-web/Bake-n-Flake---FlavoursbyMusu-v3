...
const data = [
      ...
      ["pure chocolate, পিওর চকলেট", "We use high-grade pure cocoa to ensure an authentic rich chocolate experience. 🍫", "খাঁটি চকোলেটের স্বাদ নিশ্চিত করতেসঙ্গত করতে আমরা হাই-গ্রেড পিওর কোকো ব্যবহার করি। 🍫", "choc", ""],
      ...
      ["18th birthday, ১৮ তম জন্মদিন", "Celebrate hitting adulthood with our trendy and quirky 18th birthday cakes! 🥳", "আমাদের ট্রেন্ডি ও মজাদার কেক দিয়ে ১৮তম জন্মদিনের উদযাপন করুন! 🥳", "bday", ""],
...
data.forEach((item, index) => {
    ...
    if (keywords.includes("hi") || keywords.includes("hello")) { // Give greeting intent higher priority if needed, or simply append.
    }
